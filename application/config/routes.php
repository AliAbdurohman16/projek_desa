...
// route untuk halaman aparatur desa
$route['aparatur-desa'] = 'welcome/aparaturDesa';
$route['aparatur-desa/(:num)'] = 'welcome/aparaturDesa/$1';

// route kontak
$route['kontak'] = 'welcome/kontak';
$route['kontak/(:num)'] = 'welcome/kontak/$1';
